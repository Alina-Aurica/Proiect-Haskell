...
import Parsec (Parser, andThen, orElse, pMap, pThen, parser, digit)
...
funct :: Int -> Parser String
funct nr = P.pThen (P.some (P.char ':')) (P.take nr) 
-- | Parse a bencode string
--
-- >>> P.runParser string "3:abc"
-- Success ("abc", "")
string :: Parser String
string = P.with P.number funct
  --P.fail "TODO (string)"
